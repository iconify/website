## Major icon sets restructuring

[Iconify icon sets repository](https://github.com/iconify/icon-sets) received biggest update.

Icon sets are updated automatically every few days by an automated script. Until now, the script was using old code that didn't do proper validation. With the release of [Iconify Tools 2](/docs/tools/tools2/), it is now possible to properly analyse and validate icons.
