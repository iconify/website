...
New functions for generating stylesheet for icons are available in [Iconify Utils](/docs/tools/utils/index.md):

-   [getIconCSS()](/docs/tools/utils/get-icon-css.md) to generate CSS for one icon.
-   [getIconsCSS()](/docs/tools/utils/get-icons-css.md) to generate CSS for multiple icons.
...
-   [getIconCSS()](/docs/tools/utils/get-icon-css.md) documentation.
-   [getIconsCSS()](/docs/tools/utils/get-icons-css.md) documentation.
